	...
	<table> <!-- Middle Area -->
		<tr>
			...
			<td>
				<table width="1000px"> <!-- Top area -->
					<tr>
						<td colspan="2">Community / Board</td>
					</tr>
					<tr>
						<td colspan="2"><h3>Game Title</h3></td>
					</tr>
					<tr>
						&nbsp;
					</tr>
		...
		<tr>
			...
			<div class="board"  style="background-color:black;">
				<form method="post" name="writeform" action="/Game/FreeUpdateProc.do" onsubmit="return writeSave()">
				          
			<!-- 입력하지 않고 매개변수로 전달해서 테이블에 저장(hidden) 4개 --> 
			<input type="hidden" name="com_num" value="${article.com_num}">
	  		<input type="hidden" name="pageNum" value="${pageNum}">
	     	<input type="hidden" name="com_nick" value="${com_nick}" >
				...
				<table width="1000px" cellspacing="0" cellpadding="0" align="center">
					...
					<tr>
						...
						<input type="text" class="form-control" value="${article.com_sub}" style="height:40px" name="com_sub">					
						</td>
					</tr>
					<tr>
						<td style="padding:10px" colspan="2">
							<input type="text" class="form-control" value="${article.com_content}" style="height:500px" name="com_content">											
						</td>
					</tr>
					<tr>
