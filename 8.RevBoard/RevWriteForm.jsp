	...
	<table> <!-- Middle Area -->
		...
		<tr>
			...
			<div class="board"  style="background-color:black;">
				<form method="post" name="writeform" action="/Game/FreeWriteProc.do" onsubmit="return writeSave()">
				...
				<table width="1000px" cellspacing="0" cellpadding="0" align="center">
					...
					<tr>
						...
						<input type="text" class="form-control" placeholder="Sub" style="height:40px" name="com_sub">						
						</td>
					</tr>
					<tr>
						<td style="padding:10px" colspan="2">
							<input type="text" class="form-control" placeholder="content" style="height:500px"name="com_content">											
						</td>
					</tr>
					<tr>
				...
				<!-- a링크, action의 속성값, 이벤트처리를 통해서 이동하는 경우 전부 jsp > do로 변경해야함(모델2) -->
				 <td colspan=2 align="center">
				  <input type="submit" class="btn btn-default" value="글쓰기" style="float:right; margin-top:5px; margin-right:5px;">
				</td></tr></table>    
				</form>      
			</div>
			<br><br>
