...
<div class="rows">
	...
	<!-- Board -->
	<table width="90%"> <!-- Middle Area -->
		<tr>
			<td>&nbsp;</td>
			<td style="border-bottom:1px solid grey;">
				<table width="100%"> <!-- Top area -->
					<tr>
						<td colspan="2"><h3>Community Board</h3><h5>Notification & FAQ</h5></td>
					</tr>
					<tr><td>&nbsp;</td></tr>
				</table>
			</td>
		...
		<tr>
			...
			<!--데이터의 유무  -->
			<div class="board"">
				<form method="post" name="writeform" action="/Game/HelpUpdateProc.do" onsubmit="return writeSave()">
				          
			<!-- 입력하지 않고 매개변수로 전달해서 테이블에 저장(hidden) 4개 --> 
			<input type="hidden" name="help_num" value="${article.help_num}">
	  		<input type="hidden" name="pageNum" value="${pageNum}">
	     	<input type="hidden" name="help_nick" value="${help_nick}" >
					      
				<table width="1000px" cellspacing="0" cellpadding="0" align="center">
					<tr>
						<td style="padding:10px" colspan="2">
						<input type="text" class="form-control" value="${article.help_sub}" style="height:40px" name="help_sub">
						</td>
					</tr>
					<tr>
						<td style="padding:10px" colspan="2">
							<textarea rows="30" cols="137" style="color:black;" name="help_content">${article.help_content}</textarea>
								
						</td>
					</tr>
					<tr>
						<td width="10%" style="padding:10px; margin-bottom:2;">
							<input type="button" class="btn btn-default" value="&nbsp;파일첨부&nbsp;">
						</td>
				...
				<!-- a링크, action의 속성값, 이벤트처리를 통해서 이동하는 경우 전부 jsp > do로 변경해야함(모델2) -->
				 <td colspan=2 align="center">
						<input type="submit" class="btn btn-default" value="글수정" style="float:right; margin-top:5px; margin-right:5px;">				
				</td></tr></table>    
				</form>      
			</div>
			<br><br>
