...
<div class="rows">
	...
	<table width="90%" border="0"> <!-- Middle Area -->
		...
		<tr>
			...
			<!--데이터의 유무  -->
			<div class="board">
				<form method="post" name="writeform" action="/Game/HelpWriteProc.do" onsubmit="return writeSave()">
				   
				      <!-- 입력하지 않고 매개변수로 전달해서 테이블에 저장(hidden) 5개 --> 
				      <%-- <input type="hidden" name="com_num" value="${com_num}" ><!-- ?? --> --%>
				     <input type="hidden" name="help_ad_id" value="${sessionScope.ad_id}" ><!-- 이거를 받아와야함 세션처리 -->
				...
				<table width="1000px" cellspacing="0" cellpadding="0" align="center">
					<tr>
						...
						<input type="text" class="form-control" placeholder="Sub" style="height:40px" name="help_sub">						
						</td>
					</tr>
					<tr>
						<td style="padding:10px" colspan="2">
							
							<textarea rows="30" cols="137" style="color:black;" name="help_content"></textarea>
						</td>
					</tr>
					<tr>
