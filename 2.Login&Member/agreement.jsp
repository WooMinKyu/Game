...
<jsp:include page="/1.Main/Top.jsp" /> <!-- Top menu -->
	...
	<div class="col-md-10 wrap"> <!-- Main (※90%)-->
		<center>
			<h2>회원 동의 약관</h2>
		<textarea style="color:white;width:1000px;height:700px;background-color:#303030;" cols="80" rows="20" name="agree">
...
제34조 (관할법원)
	요금 등 서비스 이용으로 발생한 분쟁에 대해 소송이 제기될 경우 회사의 본사 소재지 법원을 관할법원으로 합니다.
			...
			<div>
					<button class="btn1" onclick="document.location='Register.jsp'">동의합니다</button>
					<button class="btn2" onclick="history.back()">동의하지 않습니다</button>
	    	</div></center>
	</div>
