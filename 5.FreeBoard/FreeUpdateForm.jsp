			...
			<input type="hidden" name="com_num" value="${article.com_num}">
	     	...
	     	<input type="hidden" name="com_nick" value="${com_nick}" >
				...
				<table width="1000px" cellspacing="0" cellpadding="0" align="center">
					...
					<tr>
						<td width="10%" style="padding:10px 10px 12px 10px;">
							<button>Browse</button>
						</td>
						<td width="90%" style="padding:10px">
							<input type="text" class="form-control" style="height:35px; margin-bottom:5px; background-color:#2b2b2b; border:1px solid grey" placeholder="선택된 파일이 없습니다.">
							<!-- 필드 생성 후, 추가 예정 -->						
						</td>
					</tr>
					<tr>
						<td style="padding:10px" colspan="2">
							<textarea rows="30" cols="137" style="color:black;" name="com_content">${article.com_content}</textarea>			
						</td>
					</tr>
