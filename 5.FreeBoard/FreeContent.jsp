		...
		<tr>
			...
			<td>
				<table width="100%"> <!-- Top area -->
					...
					<tr><td>&nbsp;</td></tr>
					<tr>
						<td style="float:left; margin-left:10px"><button onclick="location.href='/Game/FreeList.do'">List</button></td>
				...
				<table width="100%" cellspacing="0" cellpadding="0"  style="background-color:#181818; color:white;">
					<tr><!-- 글제목 -->
						<td colspan="2" style="width:900px; padding-left:10px;">
							<h2>${article.com_sub}</h2>
						</td>
					</tr>
					<tr><!-- 닉네임 -->
						<td style="padding:10px;">
							<h5>Writer : ${article.com_nick}</h5>
						</td>
						<td align="right" style="padding-right:30px;">
							Date : ${article.com_wdate} &nbsp;&nbsp;조회수 : ${article.com_view}
						</td>
					</tr>
					
					<tr><!-- 글내용 -->
						<td colspan="2" style="padding:10px; border-top:1px solid grey; border-bottom:1px solid grey;">
							<pre style="background-color:#E6E6E6; color:black; font-size:16px; height:400px; border:0px">${article.com_content}</pre>
						</td>
					</tr>
					<tr><td colspan="2" style="background-color:#2b2b2b;">&nbsp;</td></tr>
					<tr>
						<td colspan="2" style="background-color:#2b2b2b;">
							<span style="float:left; margin-left:10px"><button onclick="location.href='/Game/FreeList.do'">List</button></span>
							<% if(session.getAttribute("m_id") != null || session.getAttribute("ad_id") != null) {%>
							<span style="float:right; margin-right:10px"><button onclick="location.href='/Game/FreeWriteForm.do'">Write</button></span>
							<span style="float:right; margin-right:5px"><button onclick="location.href='/Game/FreeDeleteProc.do?com_num=${com_num}'">Delete</button></span>
							<span style="float:right; margin-right:5px"><button onclick="location.href='/Game/FreeUpdateForm.do?com_num=${com_num}'">Edit</button></span>
							<%}%>						
						</td>
					</tr>
					<tr><td colspan="2" style="background-color:#2b2b2b;">&nbsp;</td></tr>	
