...
<div class="rows">
	...
	<table width="90%"> <!-- Middle Area -->
		...
		<tr>
			...
			<!--데이터의 유무  -->
			<div class="board"">
			<form method="post" name="writeform" action="/Game/AdminCsUpdateProc.do" onsubmit="return writeSave()">
				          
			<!-- 입력하지 않고 매개변수로 전달해서 테이블에 저장(hidden) 4개 --> 
			<input type="hidden" name="cs_num" value="${article.cs_num}">
			<input type="hidden" name="m_id" value="${article.m_id}">
	  		<input type="hidden" name="pageNum" value="${pageNum}">
					      
				<table width="1000px" cellspacing="0" cellpadding="0" align="center">
					<tr>
						<td style="padding:10px" colspan="2">
						<input type="text" class="form-control" value="${article.cs_sub}" style="height:40px" name="cs_sub">
						</td>
					</tr>
					<tr>
						<td style="padding:10px" colspan="2">
							<textarea rows="30" cols="137" style="color:black;" name="cs_content">${article.cs_content}</textarea>
